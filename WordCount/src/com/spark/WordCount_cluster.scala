...
//    conf.setMaster("spark://master:7077") //此时运行在集群
     ...
     * 
     * */
//    val lines: RDD[String] = sc.textFile("D://READ.md", 1) //读取文件并切分为不同的partition
    val lines = sc.textFile("/README.md") //读取文件并设置为一个partition
    /**
